...
function Section_cards() {
  return (
    <>
      <div class="flex flex-col   justify-center items-center w-fit h-screen md:px-16 bg-blue-500">

        {/* top row */}
        <div class="flex flex-col justify-around items-center md:flex-row bg-white ">

          {/* 1. box */}
          <div class="flex flex-col w-fit h-auto md:w-3/6  bg-yellow-100 m-4">
