...
function Section_contact() {
  return (
    <>
      <div class="flex flex-col relative justify-between px-4 md:px-24 py-24 bg-paul-light-rose">

        <div class="flex flex-col lg:flex-row ">

        {/* left box */}
          <div class="flex flex-col justify-start p-2 xl:w-3/6">
            <br></br>
            <h2 class="text-4xl font-medium font-fredoka tracking-tighter underline underline-offset-8 decoration-8 decoration-paul-dark-rose">Kontakt – Wie Sie uns erreichen können</h2>
            <br></br>
            <br></br>
            ...
            <div class="flex flex-row justify-start items-start">
              ...
              <div class="flex flex-row justify-center items-center">
                {/* Phone Icon */}
                <svg class="mx-2" xmlns="http://www.w3.org/2000/svg" width="28" height="40" viewBox="0 0 28 40" fill="none">
                ...
                <span class="flex flex-row justify-center items-center">+49 1800 123123</span>
              </div>
            ...
            <form class="flex flex-col justify-start items-start">
              ...
              <textarea class="text-md font-mono h-40 px-2 text-gray-300" placeholder='Beschreiben Sie Ihr Vorhaben oder Ihr Anliegen'></textarea>
              <br></br>

              <label class="text-sm font-mono text-gray-700">Bei mit * gekennzeichneten Felder handelt es sich um Pflichtfelder</label>
              <br></br>
              <div class="flex flex-row justify-start items-center">
                <input type="checkbox" class="m-2"></input>
                <label class="text-sm font-mono text-gray-700">Mit dem Senden der Nachricht akzeptiere ich die Datenschutzbedingungen</label>
              </div>
              <br></br>
              </div>
          ...
          {/* right box */}
          <div class="flex flex-row justify-center items-center p-2 xl:w-3/6">
            <img class="min-w-52" src={Image1}></img>
          </div>
