...
const Navbar_XL_dropdown_items = [
    ...
    item_5_subheading: '5 Precision Cuts That Wow',
     },
  ];


function Navbar_xl_dropdown_outdoor() {
  return (
    <>
...
export default Navbar_xl_dropdown_outdoor